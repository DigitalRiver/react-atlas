...
describe("Test CheckboxGroup component - the bascis", () => {
	it("Checkbox group - 4 checkboxes, 1 checked", function(){
		const component = mount(<CheckboxGroup title={'CheckboxGroup test'}>
									<Checkbox name={'1'}/> 
		                            <Checkbox name={'2'}/>
									<Checkbox name={'3'}/>
									<Checkbox name={'4'}/> 
...
function _verifyMinMax(mi, ma, numberOfClicks, message, expectedResult)	{
	const component = mount(<CheckboxGroup title={'CheckboxGroup test'} min={mi} max={ma} >
								<Checkbox name={'1'}/> 
								<Checkbox name={'2'}/>
								<Checkbox name={'3'}/>
								<Checkbox name={'4'}/> 
...
describe("Test CheckboxGroup component - Min/Max tests", () => {
	...
	it("Checkbox group - 5 checkboxes, max=4, min=2, 3 checked", function() {
		const component = mount(<CheckboxGroup title={'CheckboxGroup test'} max={4} min={2} limitMessage={'Limit exceed!!'} >
									<Checkbox name={'1'}/> 
		                            <Checkbox name={'2'}/>
									<Checkbox name={'3'}/>
									<Checkbox name={'4'}/> 
