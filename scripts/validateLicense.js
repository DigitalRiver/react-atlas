...
packages.forEach(function(pack) {
  spawn.sync('node-license-validator', ['--dir', pack, '--deep', '--allow-licenses', 'ISC', 'MIT', 'BSD', 'BSD-3-Clause', 'BSD-2-Clause', 'WTFPL', 'BSD-like', 'MIT/X11', 'Public Domain', 'BSD-new', 'Artistic-2.0', 'Unlicense', ' CC0-1.0'], {
    env: process.env,
    cwd: pack,
    stdio: "inherit"
  });
