...
module.exports = {
  ...
  components: 'src/components/**/[Avatar|Button|Card|Checkbox|CheckboxGroup|DatePicker|Dropdown|Form|Hint|Input|ProgressBar|Radio|RadioGroup|Switch|TextArea|TextField|Tooltip]*.js',
