...
describe("Test List component", () => {
	it('renders correctly', () => {
		const tree = renderer.create(<ListCore border>
		    <ListGroupCore title="Dinosaurs">    
		        <ListItemCore leftItem={<AvatarCore title="Blue" />} rightItem={<SwitchCore />}>
		            <ButtonCore link>Blue</ButtonCore>
		        </ListItemCore>
		        <ListItemCore leftItem={<AvatarCore title="Earl" />} rightItem={<SwitchCore />}>
