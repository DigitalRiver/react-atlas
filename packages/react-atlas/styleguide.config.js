...
module.exports = {
  ...
  components: 'src/components/**/[Avatar|Button|Card|Checkbox|CheckboxGroup|Dropdown|Form|Hint|Input|ProgressBar|Radio|RadioGroup|Switch|Table|TableHeader|TextArea|TextField|Tooltip]*.js',
